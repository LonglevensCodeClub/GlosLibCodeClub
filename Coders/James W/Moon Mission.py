...
if "F" not in user_list:
  print("Without Solar Panels,, your lunar rover wont be able to functio because of lack of power!")
  
if "I" not in user_list:
  print("You won't be able to reach the moon base without a food supply. You need energy to drive the rover!")


if "A" in user_list and "E" in user_list and "F" in user_list and "I" in user_list:
  print("Hooray! You picked the 4 correct items. You will be able to arrive safe and sound")
else:
   print("You didn't pick the 4 correct items for survival. You won't be able to make it to the moonbase")
