...
BGCOLOR = GOLD # background color on the screen
GRIDCOLOR = DARKBLUE # color of the game board
GAMEOVERCOLOR = BROWN # color of the "Game over" text.
GAMEOVERBGCOLOR = BLACK # background color of the "Game over" text.
SCORECOLOR = RED # color of the text for the player's score
