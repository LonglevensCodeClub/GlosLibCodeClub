...
class Dungeon:
    ...
    def StepsDown(self, x, y, z):
        self._mc.setBlocks(x+2, y, z-1, x+self._ROOM_HEIGHT+3, y, z-1, block.FENCE)
        self._mc.setBlocks(x+2, y, z+1, x+self._ROOM_HEIGHT+3, y, z+1, block.FENCE)
        self._mc.setBlocks(x+self._ROOM_HEIGHT+3, y, z-1, x+self._ROOM_HEIGHT+3, y, z+1, block.FENCE)
